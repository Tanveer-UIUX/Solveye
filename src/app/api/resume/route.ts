...
export async function POST(req: NextRequest) {
  try {
    ...
    // TODO: forward to CRM / send notification email to talent@solveye.health
    console.log('[resume] received', { firstName, lastName, email, phone, linkedin, jobTitle, file: safeName })
